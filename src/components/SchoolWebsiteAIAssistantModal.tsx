  ...
  const handleSend = async (userPrompt?: string) => {
    ...
    try {
      ...
      const fallbackReply: ChatMessage = {
        id: `ai-${Date.now()}`,
        sender: 'ai',
        text: `Terima kasih atas pertanyaan Anda. Untuk informasi lebih rinci, Anda juga dapat menghubungi sekretariat SDN Tangerang 6 di ${config.SCHOOL_PHONE || '(021) 5523456'} atau datang langsung ke sekolah kami pada jam kerja.`,
        timestamp: new Date().toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' }),
        isFallback: true,
      };
